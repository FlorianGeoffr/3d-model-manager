...
const STUDIO_RIG: LightingRig = { exposure: 1.0, ambient: 0.25, key: 1.6, fill: 0.55, rim: 0.9, env: 0.85, contactShadow: true };
const BRIGHT_RIG: LightingRig = { exposure: 1.25, ambient: 0.55, key: 2.0, fill: 0.9, rim: 1.1, env: 1.1, contactShadow: true };
...
// can be inspected without the studio/bright rigs' shading obscuring it.
const FLAT_RIG: LightingRig = { exposure: 1.0, ambient: 1.1, key: 0.6, fill: 0.6, rim: 0.3, env: 0.35, contactShadow: false };
